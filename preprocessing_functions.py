...
def get_transactions_out_with_adjacency_map(adjacency_map, root_transaction, max_depth=None):
    transactions_out = adjacency_map[root_transaction]
    transaction_trees_out = []
    if max_depth is None or max_depth > 0:
        for i in transactions_out:
            transaction_trees_out.append(get_transactions_out_with_adjacency_map(adjacency_map, i, max_depth - 1 if max_depth is not None else None))
    else:
        transaction_trees_out = 'max_depth reached'
...
def get_transactions_in_with_inversed_adjacency_map(inversed_adjacency_map, root_transaction, max_depth=None):
    transactions_in = inversed_adjacency_map[root_transaction]
    transaction_trees_in = []
    if max_depth is None or max_depth > 0:
        for i in transactions_in:
            transaction_trees_in.append(get_transactions_in_with_inversed_adjacency_map(inversed_adjacency_map, i, max_depth - 1 if max_depth is not None else None))
    else:
        transaction_trees_in = 'max_depth reached'
